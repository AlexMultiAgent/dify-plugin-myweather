...
def test_resolve_language_english_tw_hk_mo_text_returns_en():
    # English text like "Taipei", "Hong Kong" — no CJK chars → detected as en-US,
    # so country hints never checked. This is correct: the user typed Latin script.
...
def test_resolve_language_explicit_overrides_zh_hant_hint():
    # Explicit language selection overrides auto-detection, even with TW hint
